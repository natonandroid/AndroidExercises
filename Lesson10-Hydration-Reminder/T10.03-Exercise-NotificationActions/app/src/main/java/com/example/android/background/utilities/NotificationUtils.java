...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 4453;

    private static final int ACTION_DRINK_PENDING_COUNT_ID = 43555;
    /**
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context,
                ACTION_DRINK_PENDING_COUNT_ID,
                incrementWaterCountIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        NotificationCompat.Action addDrinkAction = new NotificationCompat.Action( R.drawable.ic_cancel_black_24px,"I did it!", pendingIntent);
        //      (16) Return the action
        return addDrinkAction;
    }
