...
public class ReminderTasks {
    ...
    public static final String ACTION_CHARGING_REMINDER = "reminder-notification";
    ...
    private static void sendReminderNotification(Context context) {
        PreferenceUtilities.incrementChargingReminderCount(context);
        NotificationUtils.sendReminderNotification(context);
    }

    private static void sendChargingReminderNotification(Context context) {
        PreferenceUtilities.incrementChargingReminderCount(context);
        NotificationUtils.sendChargingReminderNotification(context);
    }
