...
import static com.example.android.background.R.string.main_notification_channel_name;
...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_NOTIFICAITON_ID = 3344;

    private static final String WATER_REMINDER_NOTIFICAITON_CHANNEL_ID = "1122";
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 112233;
    ...
    public static void remindUserWhenCharging(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            NotificationChannel myChannel = new NotificationChannel(
                    WATER_REMINDER_NOTIFICAITON_CHANNEL_ID,
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder( context, WATER_REMINDER_NOTIFICAITON_CHANNEL_ID)
        ...
        notificationManager.notify(WATER_REMINDER_NOTIFICAITON_ID, notificationBuilder.build());
