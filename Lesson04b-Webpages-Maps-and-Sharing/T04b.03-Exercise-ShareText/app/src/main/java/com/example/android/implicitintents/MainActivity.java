...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        ...
        System.out.println("BUILT URI for map="+addressUri.toString());
        showMap(addressUri);
    }
    ...
    public void onClickShareTextButton(View v) {
        String sharingText = "I'm not your mama!";
        System.out.println("sharingText ="+sharingText.toString());
    ...
    private void shareText(String sharedText){
        ...
        String title = "Gimme sugar";

        Intent intent = ShareCompat.IntentBuilder.from(this).setChooserTitle(title).setType(mimeType).setText(sharedText).getIntent();
        startActivity(intent);
    }
